...
class BERTModel(object):
	'''Fine Tune TF Hub BERT Model - Options for TFX Pipeline Instantiation and Training'''

	def __init__(self, **kwargs):
		self.BERT_TFHUB_URL = "https://tfhub.dev/tensorflow/bert_en_uncased_L-12_H-768_A-12/2"

	def load_bert_layer(self):
   		# Load the pre-trained BERT model as layer in Keras
    	bert_layer = hub.KerasLayer(
        	handle=self.BERT_TFHUB_URL
        	trainable=True)
    	return bert_layer
